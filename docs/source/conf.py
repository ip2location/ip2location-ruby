...
myst_html_meta = {
    "description": "IP2Location Ruby library that enables user to get the geolocation information from IP2Location BIN database.",
...
html_title = "IP2Location Ruby"

html_baseurl = "https://ip2location-ruby.readthedocs.io/en/latest/"